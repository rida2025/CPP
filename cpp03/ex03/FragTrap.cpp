...
/*   Updated: 2024/04/25 19:30:54 by mel-jira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap &FragTrap::operator=(FragTrap const &cpyasy){
    std::cout << "FragTrap copy assignment was called from derived class !" << std::endl;
...
FragTrap::FragTrap(FragTrap const &cpycons){
    std::cout << "FragTrap copy constructor was called from derived class !" << std::endl;
    *this = cpycons;
}
