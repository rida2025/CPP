...
/*   Updated: 2024/04/25 19:30:10 by mel-jira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(): ClapTrap(){
    std::cout << "ScavTrap default constructor was called from derived class" << std::endl;
    this->name = "unknown";
    Hit_points = 100;
    Energy_point = 50;
    Attack_damage = 20;
...
ScavTrap &ScavTrap::operator=(ScavTrap const &cpyasy){
    std::cout << "ScavTrap cpoy assignment was called from derived class" << std::endl;
